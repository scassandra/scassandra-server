...
import org.scassandra.server.priming.batch.{BatchPrimeSingle, BatchWhen, BatchQueryPrime}
...
object PrimingJsonImplicitsForTest extends DefaultJsonProtocol with SprayJsonSupport with LazyLogging {
