...
case class CqlMap(key: DataType, value: DataType) extends DataType {
  ...
  def baseCodec(implicit protocolVersion: ProtocolVersion) = map(
    protocolVersion.collectionLengthCodec,
...
case class CqlSet(element: DataType) extends DataType {
  ...
  def baseCodec(implicit protocolVersion: ProtocolVersion) = listOfN(
    protocolVersion.collectionLengthCodec,
...
case object CqlDate extends PrimitiveType {
  val stringRep = "date"
...
case object CqlTime extends PrimitiveType {
  val stringRep = "time"

  /**
   * @see [[org.scassandra.codec.datatype.Bigint#native]]
   */
...
case object Text extends PrimitiveType {
  ...
  /**
   * @see [[org.scassandra.codec.datatype.Varchar#native]]
   */
...
case object CqlDecimal extends PrimitiveType {
...
case object CqlDouble extends PrimitiveType {
...
case object CqlFloat extends PrimitiveType {
  val stringRep = "float"
...
case object CqlInt extends PrimitiveType {
  val stringRep = "int"
...
case object CqlTimeuuid extends PrimitiveType {
...
case object CqlInet extends PrimitiveType {
  val stringRep = "inet"
...
case class CqlList(element: DataType) extends DataType {
...
object DataType {
  ...
  private[this] lazy val primitiveTypes = scala.List(
    Ascii, Bigint, Blob, CqlBoolean, Counter, CqlDecimal, CqlDouble, CqlFloat, CqlInt, Text, Timestamp, Uuid, Varchar, Varint,
    CqlTimeuuid, CqlInet, CqlDate, CqlTime, Smallint, Tinyint)
