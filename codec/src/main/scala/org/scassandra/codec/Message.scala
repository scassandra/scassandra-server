...
case class WriteTimeout(message: String = "Write Request Timeout", consistency: Consistency = Consistency.ONE, required: Int = 1, blockFor: Int = 1, writeType: String = "SIMPLE") extends ErrorMessage(message)
case class ReadTimeout(message: String = "Read Request Timeout", consistency: Consistency = Consistency.ONE, required: Int = 1, blockFor: Int = 1, dataPresent: Boolean = false) extends ErrorMessage(message)
